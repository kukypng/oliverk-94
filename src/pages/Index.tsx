        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-2xl font-bold text-gray-900">Oliver</h1>
            </div>
            <Button 
              onClick={() => window.location.href = '/auth'} 
              className="bg-[#fec832] hover:bg-[#e6b42e] text-black"
            >
              Login
            </Button>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              size="lg" 
              onClick={() => window.location.href = '/auth'} 
              className="text-lg px-8 py-3 bg-[#fec832] hover:bg-[#e6b42e] text-black"
            >
              Começar Agora
            </Button>
            <Button 
              size="lg" 
              variant="outline" 
              className="text-lg px-8 py-3 border-[#fec832] text-[#fec832] hover:bg-[#fec832] hover:text-black"
            >
              Entre em contato
            </Button>
          </div>
